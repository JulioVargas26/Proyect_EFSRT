...
(function (h) {
    ...
    function Da(a) {
        ...
        !a.sEmptyTable && (c && "No hay datos" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function vb(a, b) {
        var c = sa(a, b), d = b.sEcho !== k ? b.sEcho : b.draw,
    ...
    function ka(a) {
        var b = a.oScroll, c = b.sX, d = b.sXInner, e = b.sY, b = b.iBarWidth, f = h(a.nScrollHead), g = f[0].style,
            j = f.children("div"), i = j[0].style, n = j.children("table"), j = a.nScrollBody, l = h(j), q = j.style,
            t = h(a.nScrollFoot).children("div"),
            m = t.children("table"), o = h(a.nTHead), F = h(a.nTable), p = F[0], r = p.style,
            u = a.nTFoot ? h(a.nTFoot) : null, Eb = a.oBrowser, Ua = Eb.bScrollOversize, s = G(a.aoColumns, "nTh"), P,
            v, w, y, z = [], A = [], B = [], C = [], D, E = function (a) {
                a = a.style;
                a.paddingTop = "0";
                a.paddingBottom = "0";
                a.borderTopWidth = "0";
    ...
    function Fa(a) {
        var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, f = d.sX, g = d.sXInner,
            ...
            t = !1, m, o, p = a.oBrowser, d = p.bScrollOversize;
    ...
    var m = function (a) {
            ...
            this.each(function () {
                var e = {}, e = 1 < d ? Lb(e, a, !0) : a, g = 0, j, i = this.getAttribute("id"), n = !1, l = m.defaults,
                    q = h(this);
                if ("table" !=
                    ...
                    var w = o.oFeatures;
                    e.bStateSave && (w.bStateSave =
                        !0, Kb(o, e), z(o, "aoDrawCallback", wa, "state_save"));
                    if (e.aaSorting === k) {
                        t = o.aaSorting;
                        g = 0;
    ...
    var A = function (a, b, c) {
            a[b] !== k && (a[c] = a[b])
        }, ba = /\[.*?\]$/, U = /\(\)$/, Qa = m.util.escapeRegex, ua = h("<div>")[0], Zb = ua.textContent !== k,
        $b = /<.*?>/g, Oa = m.util.throttle, Tb = [], w = Array.prototype, dc = function (a) {
    ...
    p("cells()", function (a, b, c) {
        ...
        if (null === b || b === k) return this.iterator("table", function (b) {
            var d = a, e = ab(c), f =
                    b.aoData, g = Ba(b, e), j = Sb(ha(f, g, "anCells")), i = h([].concat.apply([], j)), l,
                n = b.aoColumns.length, m, p, r, u, v, s;
    ...
    p("destroy()", function (a) {
        ...
        return this.iterator("table", function (b) {
            var c = b.nTableWrapper.parentNode,
                d = b.oClasses, e = b.nTable, f = b.nTBody, g = b.nTHead, j = b.nTFoot, i = h(e), f = h(f),
                k = h(b.nTableWrapper), l = h.map(b.aoData, function (a) {
                    return a.nTr
                }), p;
            b.bDestroying = !0;
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Viendo _START_ hasta _END_ de _TOTAL_ registros",
            sInfoEmpty: "Viendo 0 hasta 0 de 0 registros",
    ...
    var Ca = "", Ca = "", H = Ca + "ui-state-default", ia = Ca + "css_right ui-icon ui-icon-",
    ...
    h.extend(!0, m.ext.renderer, {
        pageButton: {
            _: function (a, b, c, d, e, f) {
                var g = a.oClasses, j = a.oLanguage.oPaginate, i = a.oLanguage.oAria.paginate || {}, k, l, m = 0,
                    p = function (b, d) {
